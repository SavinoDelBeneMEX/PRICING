    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-4">
      <div className="w-full max-w-sm">
        <div className="app-header rounded-t-card px-6 py-5 text-center">
          ...
          <p className="text-white/70 text-sm mt-1">Acceso interno</p>
        </div>
        <form onSubmit={handleSubmit} className="card rounded-t-none space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="nombre@savinodelbene.mx"
            />
          </div>
          <div>
          ...
          <p className="text-center text-xs text-muted">
            ¿Eres proveedor? <a href="/proveedor/login" className="text-navy underline">Entra por aquí</a>
          </p>
        </form>
      </div>
    </div>
